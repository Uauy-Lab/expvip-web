...
TernaryPlot.prototype._renderExpBiasTooltip = function(){
...
TernaryPlot.prototype._hideExpBiasTooltip = function() {
...
TernaryPlot.prototype._indicateCircle = function(tooltipText, circle){  
...
TernaryPlot.prototype._setDefaultStateCircle = function(circle){
  circle.attr('r', 6);
  this.parent.hideTooltip();
}

TernaryPlot.prototype._renderLinesToCentroid = function(){
...
TernaryPlot.prototype._hideLinesToCentroid = function(){
...
TernaryPlot.prototype._adustTernaryHeight = function(){
...
TernaryPlot.prototype._removeTPMDataUnderThreshold = function(data){
  var tooltip_order = this.parent.data.tooltip_order,
      sum = 0,
      tpmThreshold = this.parent.data.opt.tpmThreshold;

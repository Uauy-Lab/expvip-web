...
},{"bio-vis-expression-bar":2}],2:[function(require,module,exports){
...
ExpressionBar.prototype.setupButtons = function(){
 ...
 this.saveButton = jQuery('#'+ this.opt.target+'_save');
...
ExpressionBar.prototype.setupContainer = function(){
 ...
 this._container.append('<button type="button" id="' +
  this.opt.target + '_save">Save plot</button>');
 this._container.append('<button type="button" id="' +
...
ExpressionBar.prototype._updateFilteredFactors = function(evt){
...
ExpressionBar.prototype.renderSortWindow = function(){
  ...
  for(i in this.renderedOrder){
    ...
    listText += "<div>" ;
    listText += i;
    name=this.opt.target + '_sorted_list_'+ i;
  ...
  checks.click(this._updateFilteredFactors);
...
ExpressionBar.prototype.getGroupFactorDescription = function(o,groupBy){
  var factorArray = [];
  for (var i in groupBy) {
    factorArray[i] = groupBy[i] + ':' + o.factors[groupBy[i]];
  };
...
ExpressionBar.prototype.refreshBar = function(gene, i){
  ...
  var lines = bar.selectAll('line').transition().duration(1000).ease("cubic-in-out")
     // .attr('x1', gXOffset)
      ...
      .attr('x2', function(d,j) {return x(dat[j].value + dat[j].stdev)} )
...
},{"biojs-events":3,"colorbrewer":7,"d3":8,"jquery":15,"jquery-ui/sortable":12,"jquery-ui/tooltip":13,"science":16}],3:[function(require,module,exports){
...
},{"./widget":14,"jquery":15}],11:[function(require,module,exports){
var jQuery = require('jquery');
...
},{"./core":9,"./mouse":10,"./widget":14,"jquery":15}],13:[function(require,module,exports){
var jQuery = require('jquery');
require('./core');
require('./widget');
require('./position');
...
},{"./core":9,"./position":11,"./widget":14,"jquery":15}],14:[function(require,module,exports){
var jQuery = require('jquery');
...
},{"./science.v1":17}],17:[function(require,module,exports){
(function(exports){
(function(exports){
